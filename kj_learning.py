        ...
        if packet.dst.is_multicast:
            ...
            if packet.dst not in self.macToPort:  # 4
                ...
                if tof == False:
                    ...
                    if tof == False:
                        log.info("p,dst ip:%s %s > %s", str(packet.dst), str(
                            packet.find("arp").protosrc), str(packet.find("arp").protodst))
                ...
                if temp == 0:
                    # added by jose
                    log.info(
                        "checking execution****inside packet.dst  not in self.macToPort %s", packet.dst)
